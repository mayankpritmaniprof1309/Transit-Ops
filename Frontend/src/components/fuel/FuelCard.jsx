...
import { FaGasPump, FaDollarSign, FaTachometerAlt, FaCalendarAlt, FaRoute } from 'react-icons/fa';
...
export const FuelCard = ({ fuelLog, onEdit, onDelete }) => {
  ...
  const pricePerUnit = fuelQuantity > 0 ? (fuelCost / fuelQuantity).toFixed(2) : '0.00';
    ...
    >
      <div>
        ...
        <p className="text-small mb-3 text-muted d-flex align-items-center gap-1">
          <FaCalendarAlt /> {new Date(fuelDate).toLocaleDateString()}
        </p>
        ...
        <div className="row g-2 mb-3">
          ...
          <div className="col-6">
            <div className="border rounded p-2 bg-light text-center">
              ...
              <strong className="text-dark">{fuelQuantity} L</strong>
            </div>
          </div>
          ...
          <div className="col-6">
            <div className="border rounded p-2 bg-light text-center">
              ...
              <strong className="text-dark">${fuelCost.toLocaleString()}</strong>
            </div>
          </div>
        </div>
        ...
        <div className="row g-2 mb-4">
          ...
          <div className="col-12">
            <div className="d-flex align-items-center justify-content-between text-small text-muted border-bottom pb-2">
              ...
              <span className="fw-semibold text-dark">{odometerReading.toLocaleString()} km</span>
            </div>
          </div>
          {trip && (
            <div className="col-12">
